...
$('body').on('click', '.js_unfold_code_btn', function () {
  $(this).closest('.highlight-container').addClass('on');
  $(this).closest('.highlight-container').removeClass('rm_on');
});
// 收起
$('body').on('click', '.js_retract_code_btn', function () {
  $(this).closest('.highlight-container').addClass('rm_on');
  const $container = $(this).closest('.highlight-container').removeClass('on');
...
const addCodeWrap = ($node) => {
  const $container = $node.wrap('<div class="highlight-container">' +
    '<div class="highlight-wrap"></div>' +
    '</div>').closest('.highlight-container');
